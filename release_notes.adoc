...
| https://camel.apache.org/manual/camel-4x-upgrade-guide-4_20.html#_camel_pulsar[camel-pulsar] | ✅ Full | V1 to V2 topic URI format automatically migrated. Removes cluster segment and replaces forward slashes with hyphens.
