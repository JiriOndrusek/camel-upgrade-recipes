...
| https://camel.apache.org/manual/camel-4x-upgrade-guide-4_19.html#_saga_eip[Saga EIP] | ⚠️ Partial | XML and YAML DSL automatically migrated. Java DSL not affected.
