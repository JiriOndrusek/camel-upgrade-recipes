        ...
        return new AbstractCamelJavaVisitor() {
            ...
            protected J.Literal doVisitLiteral(J.Literal literal, ExecutionContext ctx) {
                ...
                if (JavaType.Primitive.String == l.getType() && l.getValue() != null) {
                    ...
                    String newValue = ComponentUriTransformer.transformUri(value, pattern, replacement);
                    if (newValue != null) {
                        return RecipesUtil.createStringLiteral(newValue).withPrefix(literal.getPrefix());
                    }
                }
